...
const categories = ['Makanan/Minuman', 'Pakaian', 'Kerajinan', 'Retail', 'Jasa', 'Lainnya']
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{
                ...
                <Text style={{ fontSize: 13, color: '#aaa', fontWeight: '500' }}>Survey 2</Text>
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1, alignItems: 'center', paddingTop: 10, paddingHorizontal: 28 }}>
                ...
                <View style={{ width: '100%', alignItems: 'center', marginBottom: 30 }}>
                    <Text style={{ fontSize: 18, color: '#666', marginBottom: 5, textAlign: 'center' }}>
